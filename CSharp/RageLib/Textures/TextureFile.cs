...
namespace RageLib.Textures
{
    public class TextureFile : IEnumerable<Texture>, IDisposable
    {
        ...
        public int Count
        {
            get { return Textures == null ? 0 : Textures.Count; }
        }
        ...
        {
            _file = new File();
            _file.Open(systemMemory, graphicsMemory, isBigEndian, resourceType);
            BuildTextures();
        }
        ...
        {
            return (Textures ?? new List<Texture>()).GetEnumerator();
        }
