...
namespace RageLib.Textures.Decoder
{
    ...
    {
        internal static byte[] DecodeDXT1(byte[] data, int width, int height, int validLength)
        {
            ...
            for (int y = 0; y < yBlocks; y++)
            {
                for (int x = 0; x < xBlocks; x++)
                {
                    ...
                    if (blockDataStart + 8 > validLength)
                    {
                        return pixData;
                    }
        ...
        internal static byte[] DecodeDXT3(byte[] data, int width, int height, int validLength)
        {
            byte[] pixData = new byte[width * height * 4];
            int xBlocks = width / 4;
            int yBlocks = height / 4;
            for (int y = 0; y < yBlocks; y++)
            {
                for (int x = 0; x < xBlocks; x++)
                {
                    ...
                    if (blockDataStart + 16 > validLength)
                    {
                        return pixData;
                    }
        ...
        internal static byte[] DecodeDXT5(byte[] data, int width, int height, int validLength)
        {
            byte[] pixData = new byte[width * height * 4];
            int xBlocks = width / 4;
            int yBlocks = height / 4;
